...
import kotlinx.android.synthetic.main.trip_list_content.view.*
...
class HomeActivity : AppCompatActivity() {
    ...
    class SimpleItemRecyclerViewAdapter(
        private val parentActivity: HomeActivity,
                ...
                if (twoPane) {
                    val fragment = TripDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(TripDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, TripDetailActivity::class.java).apply {
                        putExtra(TripDetailFragment.ARG_ITEM_ID, item.id)
                    }
